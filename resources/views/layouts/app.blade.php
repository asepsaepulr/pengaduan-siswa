...
<head>
  ...
  <title>PENSIS||assalaam Bandung</title>
  <!-- plugins:css -->
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <li class="nav-item dropdown">
        <a id="navbar-dropdown" class="nav-link dropdown-toggle" roles="button" data-toggle="dropdown"
        aria-haspopup="true" aria-expanded="false">
        <i class="fa fa-globe"> </i>Notoficaton<span class="badge badge-danger" id="count-botification">{{auth()->user()->count()}}
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown d-xl-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item" style="margin-top: 20px;" href="{{route('datasiswa.edit', Auth::user()->id)}}">
               Edit Profile
             </a>
    ...
    <footer class="footer">
      <div class="container-fluid clearfix">
        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © {{date('Y')}}
         <a href="#" target="_blank">PENSIS||assalaam</a>. All rights reserved.</span>
       </div>
     </footer>
     <!-- partial -->
   </div>
